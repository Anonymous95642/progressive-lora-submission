"""
=============================================================================
图像描述服务 (Image Describer)
=============================================================================

本模块提供了基于LLaVA模型的图像描述服务，支持单张和批量处理。

【核心功能】
1. 单张图像描述：describe_single_image()
2. 批量图像处理：describe_batch()
3. 多样化提示模板：支持详细、简洁、场景、物体等多种描述风格
4. 自定义提示：支持用户自定义提示词

【预定义提示模板】
- detailed: 详细描述（场景、物体、颜色、构图等）
- simple: 简洁描述主要内容
- scene: 描述场景和环境
- objects: 列举并描述主要物体
- people: 描述人物和动作
- artistic: 艺术角度分析（构图、色彩、风格）
- mood: 描述情感和氛围

【使用示例】
```python
# 初始化描述服务
describer = ImageDescriber(model_path="/path/to/llava-1.5-7b")
describer.initialize()

# 单张图像描述
result = describer.describe_single_image(
...
class ImageDescriber:
    def __init__(self, 
        ...
        self.prompt_templates = {
            "detailed": "Describe this image in detail, including the scene, people, objects, colors, composition and all visible elements.",
            "simple": "Briefly describe the main content of this image.",
            "scene": "Describe the scene and environment in this image.",
            "objects": "List and describe the main objects in this image.",
            "people": "Describe the people and their actions in this image.",
            "artistic": "Analyze the composition, color and style of this image from an artistic perspective.",
            "mood": "Describe the emotions and atmosphere conveyed by this image."
        }
